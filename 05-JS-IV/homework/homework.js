...
function nuevoUsuario(nombre, email, password) {
  ...
  var obj={
    nombre: nombre,
    email: email,
    password: password //aca va sin coma ya que queda de toque la llave, es como que se cerrara el parentesis digamos.
  };
  return obj;
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  // Tu código:
          ...
          //return this.precio - (this.precio * this.precio/100);
          //}
          //};
          //return producto;
          //}
